...
//       return <MoreHorizontal size={20} className="cursor-pointer" />;
//     }
...
//         {caption && (
//           <caption className="p-2 px-4 text-left font-bold">{caption}</caption>
//         )}
//         <thead>
//           <tr>
//             {columns.map((column) => (
//               <th
//                 key={column.key}
//                 className="text-left border-lightgraypurple p-2 px-4 bg-lightgraypurple/50 text-black"
//               >
//                 {column.title}
//               </th>
//             ))}
...
//                 <td
//                   key={column.key}
//                   className="text-left p-2 px-4 bg-lightpurple border-b-lightgraypurple border-b-2"
//                 >
//                   {column.render
